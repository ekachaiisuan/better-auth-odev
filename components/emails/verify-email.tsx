                    ...
                    <Container className="bg-white rounded-[8px] p-[32px] max-w-[600px] mx-auto">
                        <Section>
                            ...
                            <Text className="text-[16px] text-gray-700 mb-[24px] mt-0 leading-[24px]">
                                Thanks {username} for signing up! To complete your registration, please verify your email address by clicking the button below.
                            </Text>
                        ...
                        <Section>
                            ...
                            <Text className="text-[12px] text-gray-500 mt-[8px] mb-0">
                                <a href="#" className="text-gray-500 underline">Unsubscribe</a> | © 2026 Your Company Name
                            </Text>
                        </Section>
                    </Container>
                </Body>
